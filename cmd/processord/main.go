...
import (
	...
	"github.com/humansdotai/bridge-monitor-process/cmd"
	config "github.com/humansdotai/bridge-monitor-process/processor/config"
	"github.com/humansdotai/bridge-monitor-process/processor/humanclient"
	"github.com/humansdotai/bridge-monitor-process/processor/humanclient/cosmos"
	"github.com/humansdotai/bridge-monitor-process/processor/observer"
